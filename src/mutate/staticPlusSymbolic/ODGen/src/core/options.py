...
def parse_args():
    ...
    parser.add_argument('--allow-func', type=str, help="If set, OPGen will only analyze a list of functions specified in the input file path.")
    ...
    parser.add_argument('--gen', action='store_true', default=False, help="If set, ODGen stops analysis once it generates the object graph")
    ...
    parser.add_argument('--dataflow', action='store_true', default=False, help="Run data-flow analysis upon ODGen")
