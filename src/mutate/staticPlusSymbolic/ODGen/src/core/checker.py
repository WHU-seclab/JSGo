...
def traceback_dataflow(G, start_node=None):
    """
    very similar to traceback() but use a tailored sink function
    """
    res_path = ""
    ret_pathes = []
    caller_list = []

    expoit_func_list = ['sink_jsfuzz']
    ...
    #print("ret_pathes: ", res_path)
    print_success_pathes(G, ret_pathes, color='red')
