...
JSGo uses RESTler to produce initial HTTP requests. We did modifications on RESTler as described in 4.2.2, i.e., we remove its garbage collection mechanism as we need to reuse the resources created in its fuzzing phase.
